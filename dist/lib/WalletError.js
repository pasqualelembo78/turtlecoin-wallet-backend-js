...
(function (WalletErrorCode) {
    ...
    WalletErrorCode[WalletErrorCode["AMOUNT_UGLY"] = 59] = "AMOUNT_UGLY";
    /* The API requests a body */
    WalletErrorCode[WalletErrorCode["API_BODY_REQUIRED"] = 60] = "API_BODY_REQUIRED";
    /* The API does not have the block explorer enabled */
    WalletErrorCode[WalletErrorCode["API_BLOCKEXPLORER_DISABLED"] = 61] = "API_BLOCKEXPLORER_DISABLED";
    /* The daemon must be synced to use this method */
    WalletErrorCode[WalletErrorCode["API_NODE_NOT_SYNCED"] = 62] = "API_NODE_NOT_SYNCED";
    /* An argument supplied to the API endpoint is invalid */
    WalletErrorCode[WalletErrorCode["API_INVALID_ARGUMENT"] = 63] = "API_INVALID_ARGUMENT";
    /* An internal API error occurred */
    WalletErrorCode[WalletErrorCode["API_INTERNAL_ERROR"] = 64] = "API_INTERNAL_ERROR";
    /* Could not add transaction to the transaction pool via API */
    WalletErrorCode[WalletErrorCode["API_TRANSACTION_POOL_INSERT_FAILED"] = 65] = "API_TRANSACTION_POOL_INSERT_FAILED";
    /* Could not add candidate block to blockchain via API */
    WalletErrorCode[WalletErrorCode["API_BLOCK_NOT_ACCEPTED"] = 66] = "API_BLOCK_NOT_ACCEPTED";
    /* Could not find the requested item */
    WalletErrorCode[WalletErrorCode["API_HASH_NOT_FOUND"] = 67] = "API_HASH_NOT_FOUND";
    /* A Ledger transport is required */
    WalletErrorCode[WalletErrorCode["LEDGER_TRANSPORT_REQUIRED"] = 68] = "LEDGER_TRANSPORT_REQUIRED";
    /* Ledger based wallets do not currently support subwallets. */
    WalletErrorCode[WalletErrorCode["LEDGER_SUBWALLETS_NOT_SUPPORTED"] = 69] = "LEDGER_SUBWALLETS_NOT_SUPPORTED";
    /* Could not retrieve wallet keys from Ledger device. */
    WalletErrorCode[WalletErrorCode["LEDGER_COULD_NOT_GET_KEYS"] = 70] = "LEDGER_COULD_NOT_GET_KEYS";
    /* Incorrect Ledger wallet connected for this wallet file */
    WalletErrorCode[WalletErrorCode["LEDGER_WRONG_DEVICE_FOR_WALLET_FILE"] = 71] = "LEDGER_WRONG_DEVICE_FOR_WALLET_FILE";
